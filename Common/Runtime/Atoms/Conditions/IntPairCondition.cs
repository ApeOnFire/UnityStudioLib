...
{
    [CreateAssetMenu(menuName = "Unity Atoms/Conditions/IntPair/IntPairCondition")]
    public class IntPairCondition : AtomCondition<IntPair>
    {
        [Header("Change")]
        ...
        public override bool Call(IntPair t)
        {
